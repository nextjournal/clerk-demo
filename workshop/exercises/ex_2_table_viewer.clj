...
;; Seq of maps
(clerk/table [{:a "hello" :b "world"} {:a "hello" :b "again"}]) ;; ❌ order

(clerk/table {:a ["hello" "hello"] :b ["world" "again"]}) ;; ❌ order

(clerk/table [["hello" "world"] ["hello" "again"]])

(clerk/table (clerk/use-headers [[:a :b] ["hello" "world"] ["hello" "again"]]))

(clerk/table {:rows [["hello" "world"] ["hello" "again"]] :head [:a :b]})
